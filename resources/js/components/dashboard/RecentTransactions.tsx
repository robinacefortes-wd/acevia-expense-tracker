    ...
    <>
      ...
      >
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-semibold theme-text">Recent Transactions</h3>
          <button
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center py-10 sm:py-12">
            ...
            >
              <Receipt className="w-8 h-8 sm:w-10 sm:h-10" style={{ color: '#8151d9' }} />
            </div>
            <h4 className="theme-text text-base sm:text-lg font-semibold mb-2">No transactions yet</h4>
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-center">
                        <Badge
                          ...
                          style={{
                            backgroundColor: transaction.type === 'expense' ? 'rgba(239, 68, 68, 0.1)' : 'rgba(16, 185, 129, 0.1)',
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border text-white focus:outline-none transition-all text-base sm:text-lg"
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={() => setEditingTx(null)}
                  className="flex-1 px-4 py-3 rounded-lg border font-medium transition-colors hover:bg-white/5 cursor-pointer text-sm sm:text-base"
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 rounded-lg font-medium text-white transition-all hover:opacity-90 cursor-pointer text-sm sm:text-base"
